          ...
          <ul class="navbar-nav mr-auto" dir="ltr">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="@if(auth()->user()->image != null) {{url(auth()->user()->image)}} @else {{url('user-avatar.png')}} @endif">
              </a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">هل تريد فعلا تسجيل الخروج ؟</h5>
