                            ...
                            <div class="card z-index-0 fadeIn3 fadeInBottom col-lg-5 col-md-8 col-sm-12">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1" style="background: #22b6af;">
                                        <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">تفعيل الاشتراك</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form role="form" class="text-start" method="POST" action="{{ route('login.login_send_again') }}">
                                        ...
                                        <h5 style="text-align: right;direction: rtl">لقد تم ارسال رسالة تفعيل اشتراكك الى عنوان بريدك الإلكتروني   {{ Session::get('email') }} , يرجى النقر على رابط التفعيل المرفق بهذه الرسالة ليتم تفعيل اشتراكك</h5>
                                        <hr>
                                        <p class="mt-4 text-sm text-center">
                                            في حال لم تجد رسالة التفعيل في مجلد بريدك الوارد، الرجاء البحث عنها في مجلد "السبام" أو اضغط على زر "اعادة ارسال رابط التفعيل"
                                        </p>

                                        <div class="text-center">
                                            <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2 text-white" style="background: #22b6af;"> اعادة ارسال رابط التفعيل</button>
                                        </div>
