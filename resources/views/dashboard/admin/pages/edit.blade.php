        ...
        <div style="width: 100%">
          ...
          <div class="card">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form class="form text-right" id="update" action="{{ route('dashboard.pages.update', ['page' => $page->id])}}" method="POST">
                  @csrf
                  @method('PUT')
                  <div>
                    <div class="mb-3">
                   ...
                   <div class="mb-3">
                    ...
                    <textarea name="content" id="editor" cols="30" rows="10" class="form-control" style="resize: none;">{!! $page->content ?? '' !!}</textarea>
                   </div>
                  </div>
                </form>
            </div>
